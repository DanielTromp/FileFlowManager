...
<div class="space-y-6">
  <div class="flex justify-between items-center">
    <div>
      ...
      <p class="text-base-content/60 mt-1">Manage your FileFlow Manager configuration</p>
    </div>

    <button class="btn btn-primary btn-sm" on:click={loadConfiguration} disabled={isLoading}>
      {#if isLoading}
  ...
  <div class="card bg-base-100 shadow-xl">
    <div class="card-body">
      ...
      <p class="text-base-content/60">
        Export your configuration to share across devices or create backups. Import configurations
        to restore settings or merge rules from other sources.
      </p>
      ...
      <div class="space-y-4">
        <div>
          ...
          <button class="btn btn-primary" on:click={handleExport} disabled={isLoading || !config}>
            {#if isLoading}
        ...
        <div>
          ...
          <p class="text-sm text-base-content/60 mb-4">
            Load configuration from a TOML file. Choose whether to replace your current
            configuration or merge rules.
          </p>

          <!-- Import Mode Toggle -->
          <div class="form-control mb-4">
            <label class="label cursor-pointer justify-start gap-3">
              <input type="checkbox" class="toggle toggle-primary" bind:checked={mergeMode} />
              <div>
          ...
          <button class="btn btn-secondary" on:click={handleImport} disabled={isLoading}>
            {#if isLoading}
              <span class="loading loading-spinner loading-sm"></span>
            {:else}
              <svg
