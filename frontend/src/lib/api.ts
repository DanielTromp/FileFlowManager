 ...
 */
export async function deleteFiles(filePaths: string[], confirmDeletions: boolean): Promise<{
 ...
 * Clear cache
 */
export async function clearCache(clearChecksums: boolean, clearHistory: boolean): Promise<{
